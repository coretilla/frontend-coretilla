...
export const LENDING_POOL_ABI = [
  {
    inputs: [
      {
        name: "_mockBTCTokenAddress",
        internalType: "address",
        type: "address",
      },
      {
        name: "_mockUSDTTokenAddress",
        internalType: "address",
        type: "address",
      },
      {
        name: "_initialBTCPriceInUSDT",
        internalType: "uint256",
        type: "uint256",
      },
  ...
  {
    outputs: [],
    inputs: [{ name: "_amountBTC", internalType: "uint256", type: "uint256" }],
  ...
  {
    outputs: [],
    inputs: [{ name: "_amountUSDT", internalType: "uint256", type: "uint256" }],
    name: "fundPool",
    stateMutability: "nonpayable",
    type: "function",
  },
