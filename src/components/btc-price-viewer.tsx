            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-muted rounded-lg">
                  <div className="text-sm text-muted-foreground font-sans">24h High</div>
                  <div className="font-mono font-semibold">
                    ${priceData.high24h.toLocaleString()}
                  </div>
                </div>
                <div className="text-center p-3 bg-muted rounded-lg">
                  <div className="text-sm text-muted-foreground font-sans">24h Low</div>
                  <div className="font-mono font-semibold">
              ...
              {/* Volume and Update Time */}
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground font-sans">24h Volume:</span>
                  <span className="font-mono font-semibold">
                    {priceData.volume.toFixed(1)}B
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground font-sans">Last Update:</span>
              ...
              <div className="h-16 bg-muted rounded-lg flex items-end justify-center gap-1 p-2">
                {Array.from({ length: 24 }, (_, i) => (
                  <div
                    key={i}
                    className={`w-2 rounded-t-sm ${isPositive ? 'bg-green-500' : 'bg-red-500'}`}
                    style={{ 
