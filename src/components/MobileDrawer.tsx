    ...
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <SheetContent side="left" className="w-65 p-0">
        <div className="flex flex-col">
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={`mt-5 flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 w-full text-left ${
                          isActive
          ...
          >
            <ConnectWallet className="w-full justify-center font-sans font-medium" />
          </motion.div>
        </div>
      </SheetContent>
    </Sheet>
