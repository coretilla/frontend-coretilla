          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto">
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="text-3xl sm:text-4xl font-bold text-foreground mb-4 font-sans"
              >
              ...
              >
                Get the latest Bitcoin insights, market updates, and product announcements delivered to your inbox.
              </motion.p>
              ...
              >
                ...
                <Button 
                  size="lg"
                  className="bg-primary hover:bg-primary/90 h-12 px-8 font-sans font-semibold"
                >
                  Subscribe
                </Button>
              </motion.div>
