...
import { ArrowLeft, TrendingUp, Shield, AlertTriangle, Percent } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold text-foreground mb-2 font-sans">Lending & Borrowing</h1>
            <p className="text-muted-foreground font-sans">
              Earn yield by lending or access liquidity by borrowing
            </p>
          </div>
        </div>
