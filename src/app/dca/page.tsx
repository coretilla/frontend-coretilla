      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold text-foreground mb-2 font-sans">DCA Bitcoin Investment</h1>
            <p className="text-muted-foreground font-sans">
              Set up recurring Bitcoin purchases to dollar-cost average your investment
            </p>
          </div>
        </div>
